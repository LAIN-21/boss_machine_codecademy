...
This is one of codecademy's Off-Platform projects for back-end development. It must be said that I only worked on the folder called 'server' and its contents. All of the front-end (react, html, css, js) was given by the course as it would've taken me weeks to complete all of the rest. This project was fun and gave me an insight on how complicated apps can be. 

**Below you will find all of the instructions given by codecademy**
